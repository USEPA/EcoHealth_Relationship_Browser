var graph = {
  ...
  "edges": [
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Access or proximity to green space": [
          "Many studies have found that people who live close to green space visit them more frequently and thus increase their time spent in physical activity, both at the green space itself and walking or biking to the area instead of driving (Giles-Corti et al., 2005; Mowen et al., 2007; Grigsby-Toussaint et al., 2011; Wendel-Vos et al., 2004; Cohen et al., 2006; Edwards et al., 2014; Han et al., 2014; Lachowycz and Jones, 2014 ). One study found that living in an area with high parkland density (greater than 0.14%) increased the odds (OR=1.19) of meeting federal guidelines for MVPA and VPA (West et al., 2012). Another study found that as the density of public green space increased by one unit, walking was predicted to increase by 8.6% (Pliakas et al., 2014). A Swedish study found that people with green spaces within 50m of their homes visited those spaces 4x as much as those whose closest green space was 1km away (Grahn and Stigsdotter, 2003). In San Diego, the presence of a park within a 50-meter buffer of each accelerometer study point was associated with 41% higher odds (OR 1.41) of light physical activity in adolescent females (Rodriguez et al., 2012; n=293). However, several studies have found little to no association between access or proximity to green space and physical activity (Hillsdon et al., 2006; Maas et al., 2008)."
        ], 
        "Amount and design of green space:": [
          "The size of nearby public open spaces has been positively associated with physical activity (Paquet et al., 2013; Fan et al., 2015). Positive correlations have been found between number of park visitors, as well as diversity of visitor activities, and number of trees and canopy coverage (Adinolfi et al., 2014). One study found that individuals living in the greenest urban quintile were 1.39 times more physically active than those living in the least green urban quintile (Mytton et al., 2012). Another study reported that respondents whose residential environment contained high levels of greenery (on a scale from 1-5) were 3x more likely to be physically active, and 40% less likely to be overweight or obese (Ellaway et al., 2005). Yet another study found that increased exposure to neighborhood greenness from 10th to 90th percentile was associated with a 34% to 39% increase in odds for moderate to vigorous physical activity (MVPA) in children (Almanza et al., 2012). Cross-sectional study of middle-school aged children found that a 5% increase in neighborhood area covered by trees was associated with 5% higher frequency of physical activity outside of school hours (Janssen and Rosu, 2015). Elderly men were shown to participate in regular physical activity when living within a 400-meter radius green space buffer around the home (OR=1.21) (Gong et al., 2014). Strong positive associations were reported between the odds of walking and both density of street trees and street network connectivity, and also between distance walked and both overall greenness and density of street trees (Sarkar et al., 2015). &#xD;&#xD;In urban areas, street intersections and other pedestrian amenities are a promoting factor in physical activity (Wetter et al., 2001; Kaczynski et al., 2014). Children engaged in significantly greater amounts of MVPA and PA after the conversion of a traditional playground or school yard into one modeled on natural environments (Coe et al., 2014; Jansson et al., 2014), or when community spaces were comprised of vegetation, open meadows, and/or undulating topography (Lestan et al., 2014). However, while school areas with the greatest amount of green space were among children&#39;s favorites, the areas of mixed green and built environments were where the most physical activity took place (Martensson et al., 2014)."
        ], 
        "Perceptions of green space": [
          "Increases in individual satisfaction with neighborhood green space, perception of recreation areas, and perception of their easy access were found to be contributing factors to increases in overall MVPA and PA in parks (Bai et al., 2013; Jeppesen et al., 2014; Jongeneel-Grimen et al., 2014; Lee et al., 2014). A multi-country study found that adult recreational walking was strongly associated with perceived neighborhood environmental attributes such as land use mix, street connectivity and aesthetics (Sugiyama et al., 2014). One study found that, in a living environment perceived as green, 62% of the aging population engaged in high levels of physical activity while only 11% engaged in physical activity in an environment perceived as containing little green space (Kemperman and Timmermans, 2014). Also, being nature-oriented was more important than park access as a predictor of park use (p less than 0.01) (Lin et al., 2014). Zhang et al. (2015) found that five variables had significant effects on respondents&#39; satisfaction levels when participating in physical activities in urban green spaces: housing price of the residential units where respondents lived (p=0.001), travel time to the nearest park (p less than 0.0001), counts of types of green spaces available for physical activities (p=0.04), and the rating of vegetation (p less than 0.0001)."
        ], 
    ...
    }, 
    {
      ...
      "text": {
        "Urban Ecosystems | Heat Hazard Mitigation": "Green spaces within urban areas can decrease daytime atmospheric temperatures through shading and evapotranspiration, thus decreasing the Urban Heat Island effect (UHI). Increasing vegetative cover and adding higher reflective surface materials in urban areas can reduce temperatures within the area (Jenerette et al., 2011; Rotem-Mindali et al., 2015) and increase the amount of cooling energy savings; these benefits increase with time as trees mature and dead trees are replaced with new ones (Solecki et al., 2005). &quot;Urban cooling islands&quot; (UCIs) (Shashua-Bar et al., 2009) are most often associated with urban trees and forests; one study linked a one-hectare increase in urban forest area to a mean temperature decrease of 0.5&#176; Celsius (0.9&#176; F) (Kong et al., 2014). An urban drylands study found that, for every 10% increase in vegetation cover, daytime mean temperature in census block groups decreased by 2.8&#176; C (5.04&#176; F) in June and 2.4&#176; C (4.32&#176; F) in October (Buyantuyev and Wu, 2010). Both grass and tree cover greatly affect surface and air temperatures: measures of grass temperature were up to 24&#176; C (43.2&#176; F) cooler than local maximum surface temperature (similar to model predictions), while temperatures in tree shade were up to 19&#176; C (34.2&#176; F) cooler (Armson, Stinger and Ennos 2012). High xeric vegetation cover adapted to low water availability was shown to have the greatest temperature reduction at night vs. daytime periods (e.g. -2.4 vs. -1 &#176; C or 4.32 vs. -1.8&#176; F) (Chow et al., 2012). &#xD;&#xD;The presence of shade trees can increase the daily average temperature at which air conditioning use begins, from 18.7 to 20.3&#176; C (65.7&#176; to 68.5&#176; F), thus reducing summer energy usage (Akbari et al., 1997). In one study, street segments with trees had lower ambient temperatures by as much as 5.6&#176; C (10.1&#176; F) and lower surface temperatures by as much as 27.5&#176; C (49.5 &#176; F) when compared to exposed streets, indicating significant microclimatic buffering by trees (Vailshery et al., 2013). Both the extent and configuration of green space are related to variability in urban temperatures. One study found that the most important influences on temperature were the shape and area of tree patches, and the connectivity of grass and shrub patches (Chen, 2014). Similarly, variables that combined percentage green space, edge density, and patch density explained the most variance in land surface temperature (Maimaitiyiming et al., 2014). &#xD;&#xD; A study of green roofs found that maximum green roof temperatures were 15-20&#176; C (27-36&#176; F) lower than that of bare rooftops (Nardini et al., 2012). A regional simulation model using 50% green-roof coverage distributed evenly throughout a city showed ambient temperature reductions as great as 2&#176; C (3.6&#176; F) in some areas (Bass et al., 2003). Another study found that succulent-based green roofs can provide rooftop temperature reductions of up to 27.5&#176; C (49.5&#176; F) during hot, dry summer conditions (Dvorak and Volder, 2012). &#xD;&#xD;In areas with no vegetation, the Thermal Humidity Index (THI) in summertime was greater than 27&#176; C or 80.6&#176; F (the level where people begin to experience heat fatigue and other health risks). However, for vegetated areas including irrigated lawn, shade trees and a combination of both, THI was less than this threshold (Song and Wang, 2015). During the summer, human discomfort may be more pronounced in an urban vs. rural desert environment since irrigated urban green space (i.e. parks, lawns, and street trees) can increase air humidity and aggravate heat stress (Potchter and Ben-Shalom, 2013). Thermal discomfort (summarized by Thom&#39;s discomfort index) can also be triggered when air pollution (PM10, NO2, and O3) is high during heat wave days (Papanastasiou et al., 2015).  ", 
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Mitigation of PM10": [
          "Multiple modeling studies have linked tree cover to a 1-2% local reduction in particulate matter smaller than 10 micrometers (PM10). Annually, this can equate to more than 100 metric tons in Mexico City (Baumgardner et al., 2012) and more than 2,000 metric tons in the city of London (Tallis et al., 2011). With strategic tree placement, annual reductions in ambient concentrations of PM10 may reach 7-20% (Bealey et al., 2006). Hedge shrubbery has been found to collect PM10 with 34% efficiency (Tiwary et al., 2008). Conifers and broad-leaved species with rough surfaces, and species with high leaf wax capture the highest quantities of PM (Beckett et al., 2000; Popek et al., 2013; Rasanen et al., 2013; Nguyen et al., 2015)."
        ], 
        "Urban tree cover and mitigation of additional air pollutants": [
          "In addition to PM10, trees can reduce ambient concentrations of PM2.5, ultrafine particles (less than 1 micrometer) (Beckett et al., 2000) and gaseous pollutants including ozone, nitrogen dioxide, sulfur dioxide, and carbon monoxide (Nowak et al., 1994). Based on an air pollution tolerance index (APTI) and anticipated performance index (API) for long-term air pollution abatement, most suitable plant species identified and recommended for development of urban forest in Varanasi, India, were Ficus benghalensis L. (APTI=26.01, API=6) and Ficus religiosa (APTI=23.35, API=6). Additional good performers were Polyalthia longifolia, Ficus glomerata (Roxb.), Anthocephalus indicus and Mangifera indica (Pandey et al., 2015). NO2 levels were found to be 7% lower in a forest stand than in nearby, non-canopy areas during all Fall sampling seasons (Grundstrom and Pleijel, 2014). Urban streets with trees have been shown to have as much as 65% lower SO2 levels and lower suspended PM levels when compared to unbuffered streets (Vailshery et al., 2013). Ozone uptake and removal was found to vary among tree type and season in Rome, with the highest removal in spring and summer by deciduous broadleaf species (Manes et al., 2012). Tree stands consisting of multiple species removed greater amounts of O3 across annual differences in weather patterns, typical seasonal fluctuations, and variance in O3 concentrations than single tree species (Manes et al., 2014). In northern climates with a short growing season, the ability of urban trees to remove air pollutants may be minimal (Setala et al., 2013). However, another study found relatively comparable removal of NO2 and PM2.5 in summer and winter, with more removal in the winter (King et al., 2014)."
        ], 
        "Near-road vegetative buffers": [
          "In addition to reducing ambient air pollution, trees and shrubbery can trap or divert vehicular air pollutants coming directly from a busy roadway (Brantley et al., 2014). Diesel exhaust and other harmful emissions are elevated beyond background levels as far as 500m from a road edge. Roadside greenbelts have been found to reduce total suspended particles by up to 65% (Islam et al., 2012). Higher greenness within and surrounding school boundaries (50m buffer) was associated with lower indoor and outdoor NO2, ultrafine particles, and traffic-related PM2.5 levels (Dadvand et al., 2015). The effectiveness of near-road vegetative buffers is highly dependent on local factors including temperature, precipitation wind speed and direction, design of the built environment, and human activity patterns (Wania et al., 2012; Mori et al., 2015). Particle concentrations may be higher directly underneath near-road tree canopy where it has become entrapped. Tall buildings in downtown areas can modify wind flow such that tree cover may exacerbate particle concentrations in urban &quot;street canyons&quot; (Wania et al., 2012)."
        ], 
        "Green roofs": [
          "Modeling has shown that constructed green space--green roofs composed of grass or shrubs, and green walls supporting vines and other herbaceous plants--can augment the effect of ground-level trees and shrubs in air pollution mitigation (Currie and Bass 2008). It has been estimated that 2000m&#178; of uncut grass on a green roof can remove up to 4000 kg of particulate matter (Johnston and Newton, 1996). Green roofs also reduce air pollutants indirectly by decreasing building energy consumption and thus, emissions."
        ], 
        "Urban parks": [
          "Green space can reduce ambient urban air pollutant concentrations also by displacing pollutant sources, such as roads and buildings. Urban parks yielded mean values of 89ppb for NOx and 24 mG/m3 for PM10, while means for an urban street were 413ppb and 80 mG/m3, respectively. Dust mitigation was attributed to park trees, especially during dust flow episodes (Cohen et al., 2014). Vegetation can also increase air pollution through the production of pollen, fungal spores, and volatile organic compounds (Prendez et al., 2013), which contribute to ozone formation (Calfapietra et al., 2013)."
        ], 
    ...
    }, 
    {
      ...
      "text": {
        "Urban Ecosystems | Aesthetics & Engagement With Nature": "Urban ecosystems provide the opportunity to engage with nature through the use of urban green spaces such as parks, public and private gardens and urban forests. People who live close to green spaces may visit them more frequently (Giles-Corti et al., 2005; Mowen et al., 2007). Positive correlations have been found between number of park visitors and number of trees and canopy coverage, as well as diversity of visitor activities (Adinolfi et al., 2014). Urban blue spaces have also been identified as popular places for leisure and recreational activities (Volker &amp; Kistemann 2013). Urban green and blue spaces, including public parks, private gardens, and promenades, provide areas for people to not only engage with nature, but to rest and interact (Seeland et al., 2009; Ward et al., 2010; Freeman et al., 2012; Volker &amp; Kistemann 2013; Han et al., 2013; Peschardt et al., 2014). &#xD;&#xD;Green spaces, along with even sporadic greenness such as street trees, increase local aesthetic value and are cooler than developed areas, encouraging people to spend more time outdoors. As plant species richness increased, visitors had a greater mean aesthetic appreciation of experimental grassland ecosystems (F4,95 = 71.1, p less than 0.001) and natural meadows (r = 0.75, F1,70 = 91.3, p less than 0.001) (Lindemann-Matthies et al., 2009). A study of Slovenic neighborhoods found that residents living in new developments that did not have many trees rated their communities less aesthetically appealing than those in older communities that had trees (Lestan et al., 2014). Subjects who perceived the absence of greenery and other public assets (places to sit or walk, or safe places for children to play) in their neighborhoods were more likely to not have taken a walk of 1 mile or more in the last year (Ellaway et al., 2009; n=1637, Scotland). A photo questionnaire assessing the relationship between two measures of street cover density (panoramic photographs and Google Earth aerial images) and landscape preference revealed that subjects preferred 41% and 20% tree cover, respectively (Jiang et al., 2015). In a study of green roofs, interviewees reported more aesthetic benefit from green roofs when the vegetation was in their direct line of site (Loder, 2014). &#xD;&#xD;Exercising, passively spending time in green environments, and even viewing them through a window, have been shown to have multiple positive effects on health (see the health linkages to Aesthetics &amp; Engagement with Nature). Respondents in another study reported that green roofs provided stress reduction benefits and an overall calming effect when visible in an urban environment (Loder, 2014). ", 
    ...
    }, 
    {
      ...
      "target_text": "Air Quality", 
      "text": {
        "Forests | Air Quality": "Forested environments are important to the process of natural air filtration. Forests and trees have been shown to reduce ambient concentrations of the harmful air particles PM10 and PM2.5, as well as carbon monoxide, sulfur dioxide, nitrogen dioxide and ozone (Bealey et al., 2006; Pullman, 2009; Escobedo and Nowak, 2009). One study found that air pollutant removal by urban trees resulted in an average monthly air quality improvement of 1.5 percent (Escobedo and Nowak, 2009). The efficiency of trees to remove air pollutants varies by tree species, with conifers dominating (Beckett et al., 2000). In one study, coniferous trees captured 184.93 micro-g/m3; the lowest capture rates were for grassland and the control (145.28 and 107.58 micro-g/m3, respectively). Broadleaf forests were most effective at capturing PM2.5 when leaves were fully emerged (Nguyen et al., 2015). Given that air pollutants negatively affect health by exacerbating or causing conditions such as asthma and bronchitis, the removal of these pollutants from the air has the potential to decrease cases of such respiratory illnesses. ", 
    ...
    }, 
    {
      ...
      "target_text": "Water Quality", 
      "text": {
        "Forests | Water Quality": "Forested stream buffers have been found to remove up to 100% of nitrogen (Schoonover et al., 2005; Vidon and Hill 2004), 89% of phosphorous (Syversen et al., 2005), 91% of particles (Syversen et al., 2005), 97% of sediment (Lee et al., 2003), and 100% of certain pesticides (Schulz and Peall 2000) that were measured in surface runoff. Studies have shown that within forested stream buffers, nitrogen and pesticide removal efficiency increase exponentially with buffer width (Zhang et al., 2010) and that trees are more efficient at removal than grasses alone or trees and grasses combined (Zhang et al., 2010; Hefting et al., 2005). In rural Africa, the presence of forest cover within 25 km&#178; of the home has been linked to decreased odds of diarrhea in children less than 5 years old: from 15% (at 10-19% forest cover) to 92% (at 50-59% forest cover); these findings suggest natural filtration of drinking water sources (Johnson et al., 2013). For high-intensity land use, a 60-meter forested stream buffer is recommended, for moderate, 45 meters, and low, 30 meters. To protect isolated water bodies and wetlands, a 120m buffer is recommended and for steep slopes and/or cleared hills a 40m buffer is recommended (Hansen et al., 2010). ", 
    ...
    }, 
    {
      ...
      "target_text": "Air Quality", 
      "text": {
        "Drylands | Air Quality": "Vegetative cover in urban and rural desert environments can reduce ambient air pollutant concentrations both by removal and by airflow displacement. Pinyon-juniper stands have shown the highest capacity to remove criteria air pollutants (e.g., PM10, O3, NO2), followed by shrublands and grasslands (Dicus et al., 2009). Mean ambient NOx and PM10 have been measured at 89ppb and 24 mg/m3, respectively, in urban parks, while means for an urban street were 413ppb and 80 mg/m3, respectively (Cohen et al., 2014). &#xD;&#xD;Dust storms are frequent in dryland environments, where low-pressure and high wind-speed conditions can increase average PM2.5 and PM10 concentrations (Zhang et al., 2008; Hosseini et al., 2015). Naturally-occurring biological soil crusts (biocrusts) and vegetative cover (e.g., trees, shrubs, grasses) can decrease soil erosion rates by holding soil in place and/or by reducing wind. For example, during periods of dust flow, park trees were found to reduce PM10 from 218 micro-g/m3 to 64 micro-g/m3 (Cohen et al., 2014). Significant negative correlation (-0.59 at 99% CI) have been observed between vegetative cover and occurrences of spring dust storms (Zou and Zhai 2004). Experimental plots with 100% grass cover reductions experienced 10 times greater erosion rates than control plots with 0% grass cover reductions (p=0.05) (Li et al., 2007). Furrowing and seeding three native perennial shrubs and bunch grass in previously tilled or over-grazed land helped reduce fugitive dust emissions by more than 80% by adequately stabilizing soil (Grantz et al., 1998). At wind velocities of 18, 22, and 25 m/s, soil covered with 90% biocrust had wind erosion rates (g/min) 46, 21, and 17 times lower than those on sandy soil with 0% biocrust (Zhang et al., 2006). ", 
    ...
    }, 
    {
      ...
      "target_text": "Aesthetics & Engagement With Nature", 
      "text": {
        "Drylands | Aesthetics & Engagement With Nature": "Dryland environments with dense and diverse vegetation are preferred among visitors seeking natural and relaxation experiences. Survey respondents rated dryland forests with very dense vegetation and high levels of complexity and mystery as more aesthetically pleasing than grassland landscapes with sparse vegetation (De Val and Muhlhauser 2014). Positive correlations have been found between number of dryland park visitors, as well as diversity of visitor activities, and the number of trees and canopy coverage (Adinolfi et al., 2014). The results of visitor surveys and interviews in six dryland botanic gardens revealed that enjoyment of the natural beauty and exercise were the main visitor activities (Ward et al., 2010). ", 
    ...
    }, 
    {
      ...
      "target_text": "Heat Hazard Mitigation", 
      "text": {
        "Drylands | Heat Hazard Mitigation": "In arid urban landscapes, cooling islands are most often associated with trees and forests (Shashua-Bar et al., 2009). One study found that, for every 10% increase in vegetation cover by census block group, daytime mean temperature decreased by 2.8&#176; C (5.04&#176; F) in June and 2.4&#176; C (4.32&#176; F) in October (Buyantuyev and Wu, 2010). Another study reported that vegetated cover (measured as normalized difference vegetation index) reduced ambient temperatures on low-humidity summer days by up to 25&#176; C (45&#176; F) compared to bare soil (Jenerette et al., 2011). Green residential areas had lower mean land surface temperature (21.7&#176; C or 71.06&#176; F) than public parks (22.3&#176; C or 72.14&#176; F) and industrial sites (24.4&#176; C or 75.92&#176; F), due to higher percent vegetative cover (Rotem-Mindali et al., 2015). Drylands vegetation adapted to low-water conditions (xeric) was shown to have the greatest temperature reduction at night vs. daytime periods (e.g. -2.4 vs. -1 &#176; C or 4.32 vs. -1.8&#176; F) (Chow and Brazel, 2012). Green roofs were also shown to mitigate high temperatures in dryland urban areas. One study found that maximum green roof temperatures were 15-20&#176; C (27-36&#176; F) lower than those of bare rooftops (Nardini et al., 2012). Another study found that succulent-based green roofs can provide significant rooftop temperature reductions of up to 27.5&#176; C (49.5&#176; F) during hot, dry summer conditions (Dvorak and Volder, 2012). &#xD;&#xD;During high temperature and humidity conditions in arid regions, thermal comfort is improved by the presence of vegetative cover. In areas with no vegetation, the Thermal Humidity Index (THI) in summertime was greater than 27&#176; C or 80.6&#176; F (the level where people begin to experience heat fatigue and other health risks). However, for vegetated areas including irrigated lawn, shade trees and a combination of both, THI was less than this threshold (Song and Wang, 2015). When courtyards were shaded by trees or mesh, thermal stress was reduced by nearly a half and when combined with grass, it further produces a modest reduction in stress (Shashua-Bar et al., 2011). During the summer, human discomfort may be more pronounced in an urban vs. rural desert environment since irrigated urban green space (i.e. parks, lawns, and street trees) can increase air humidity and aggravate heat stress (Potchter and Ben-Shalom, 2013). Thermal discomfort (summarized by Thom&#39;s discomfort index) can also be triggered when air pollution (PM10, NO2, and O3) is high during heat wave days (Papanastasiou et al., 2015). ", 
    ...
    }, 
    {
      ...
      "target_text": "Water Hazard Mitigation", 
      "text": {
        "Drylands | Water Hazard Mitigation": "Conifer species have the highest minimum and maximum surface water storage capacities. The mean storage capacities were nearly 2 times greater for coniferous species than for broadleaf evergreen and broadleaf deciduous species (Xiao and McPherson, 2015). Among desert shrubs, mean canopy water storage capacity (expressed in water storage per leaf area) was greater for needled shrubs (A. ordosica=0.61 mm) than for ovate-leaved shrubs (C. korshinskii=0.39 mm and H. scoparium=0.43 mm) when rainfall intensities ranged from 1.15 to 11.53 mm h-1 (Wang et al., 2012). In semi-arid landscapes including dry grasslands and thorn shrublands, greater plant cover can reduce precipitation-generated runoff compared to bare soil plots (Greene et al., 1994; Chirino et al., 2006). Infiltration rates and resistance to overland flow were found to be approximately 10 and 4 times greater, respectively, on grassland compared to shrubland hillslopes (Abrahams et al., 1994). Another study revealed that grassland communities generated 150% less runoff under simulated rainfall conditions than shrubland communities (Neave and Abrahams, 2002). Green roofs in dryland urban environments can reduce the impacts of stormwater runoff as well; rooftops consisting of succulent, shrub, and herbaceous plant species reduced water runoff by more than 80-90% compared to bare rooftops (Nardini et al., 2012; Volder and Dvorak, 2014). &#xD;&#xD;Biological soil crusts can also reduce runoff and increase infiltration rates and water storage capacity. One study reported a 27% reduction in rainfall runoff by artificially propagated soil crusts after the first three years of inoculation compared to control plots (Xiao et al., 2015). Runoff volume was found to be two times greater on cyanobacterial crusts than on lichen crusts (H=14.63, p=0.0001) (Lazaro and Mora, 2014). Runoff from biocrust patches was found to be 2.6 times greater than that from shrub patches (Li et al., 2008). Infiltration rates were 3.4-times greater through the biological soil crust than through rabbit-disturbed soils (F1.16=47.8, p less than 0.001) (Eldridge et al., 2010). Artificial destruction of moss-dominated biological soil crusts decreased soil water content by up to 18% and decreased water storage in the soil (first 0-90cm) by 7.8mm, 4.4mm, 8.0mm, and 4.9mm in the second, third, fourth, and seventh year, respectively (Xiao et al., 2014). ", 
    ...
    }, 
    {
      ...
      "target_text": "Water Quality", 
      "text": {
        "Wetlands | Water Quality": "Wetlands are often thought of as sinks that collect and remove contaminants (Vellidis et al., 2003). Studies show that wetlands can remove up to 99% of nutrients (Xiong et al., 2011), 89% of metals (Khan et al., 2009) and 100% of pesticides (Budd et al., 2009). Water-quality discriminant analysis indicated that a reclaimed-water replenishment wetland removed 42.15% of total of nitrogen, 47.34% of total phosphorus, and 28.56% of nitrate from reclaimed water (Guo et al., 2015). The efficiency of wetlands varies based on the plant rhizosphere bacterial community (Guo et al., 2015), plants and soil types in the wetland and the amount of time it takes water to flow through the wetland (Budd et al., 2009). Plant species living in the wetlands greatly affect the amount and type of contaminants that can be removed; for example, Water cabbage has been found to remove up to 91% of chromium (Maine et al., 2004) while Water Hyssop removed only 51% of chromium (Rai et al., 2005). Wetlands can also be used to further treat waste water after it has passed through a waste water treatment plant (Hunter et al., 2009; Agudelo et al., 2010; Xiong et al., 2011). Bacterial contamination, such as that from agricultural flows, can also be effectively removed using wetlands; 66-91% of E. coli concentrations and 86-94% of enterococci concentrations were retained in a constructed wetland, with removal efficiencies of up to 97% (Diaz et al., 2010). In water flowing through the wetland of Ottawa National Wildlife Refuge and into Lake Erie beach waters, E. coli and P levels were high at the site where water enters the Refuge (mean E. coli=507 CFU/100 mL; mean total P = 535 &#181;g/L), but steadily decreased as water flowed through the wetland and onto the beach (mean E. coli=10 CFU/100 mL; mean total P=41 &#181;g/L) (Rea et al., 2015). Plants adapted to saline conditions can also decrease salinity in treated waste water. For instance, a halophyte plant (Bassica indica) reduced salinity (measured by electric conductivity) by up to 19.9% in a vertical flow constructed wetland after 10 days from planting compared with unplanted control system (Shelef et al., 2012). ", 
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  As measured by PM10 concentration, bronchitis rates are 2.2 times higher in the most polluted Swiss city (33 micro-g/m3) when compared to the least polluted city (10 micro-g/m3) (Braun-Fahrlander et al., 1997; n=4,470, Switzerland). ", 
          ...
          "[5]  Declining PM10 was found to be associated with declining prevalence of bronchitis in children (OR=0.66) (Bayer-Oglesby et al., 2005; n=9,591, Switzerland). "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Emergency room admissions for chronic bronchitis and emphysema increased by 31% with a 2.7-fold increase in sulfur dioxide (S02) in the same day, and by 39% after a 3-day lag period in the SO2 event for individuals less than 65 years old (Ponka &amp; Virtanen 1994; n=2,807, Helsinki, Finland). ", 
          "[2]  Levels of NO2, NOX and PM10 were found to be negatively associated with lung function or lower levels of forced vital capacity (FVC) and forced respiratory volume in 1 s (FEV1). An increase of 10 micro-g/m-3 in ambient NO2 levels was associated with a 14.0 mL decrease in FEV1 (-14.0 mL, 95% CI -25.8 to -2.1) and FVC (-14.9 mL, 95% CI -28.7 to -1.1). An increase of 10 micro-g/m-3 in PM10 levels was associated with decreases in FEV1 (-44.6 mL, 95% CI -85.4 to -3.8) and FVC (-59.0 mL, 95% CI -112.3 to -5.6) (Adam et al., 2015; n=13,259, Europe). ", 
          "[3]  A cohort study analyzed the relationship between exposure to ambient air pollutants in women during the second trimester of pregnancy and lung function in their preschool children. Forced respiratory function in 1 s (FEV1) estimates for an IQR increase in exposure were found to be -18.4 mL (95% CI: -34.8 to -2.1) for benzene and -28.0 mL (95% CI: -52.9 to -3.2) for NO2. Higher levels of ambient benzene and NO2 during pregnancy were associated with reduced lung function in preschool children (Morales et al., 2015; n=620, Sabadell and Gipuzkoa, Spain). "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Trees&#39; effects on asthma": [
          "[1]  The amount of urban tree canopy within 250m of the home has been positively associated with asthma prevalence at 7 years of age. For every 8% increase in tree cover, asthma prevalence increased by 17% (Lovasi et al., 2013; n=427, New York City). ", 
          "[2]  Residential proximity to forest land (within 300m) was not associated with children&#39;s asthma prevalence. However, residential proximity to parkland was associated with 60% higher relative prevalence of asthma, potentially due to the common practice of siting non-native species in parks as opposed to forests (Dadvand et al., 2014; n=3,178, Spain). ", 
          "[3]  For interquartile increases in daily tree pollen concentrations, percent increases in daily hospitalizations for asthma were: 2.63% (95% CI 1.19-4.07) for Ulmus (elm); and 2.45% (1.12-3.78) for the group containing Pinaceae (pine, fir, spruce), Tsuga (hemlock) and Larix (larch, tamarack).  Associations between daily asthma hospitalizations and pollen counts for oak and maple species were not statistically significant (Dales et al., 2008; n=60,000, multiple cities in Canada). ", 
          "[4]  Spring peaks in asthma hospitalizations and visits to emergency departments were correlated (R=0.24 and R=0.36, respectively) with tree pollen counts (Jariwala et al., 2014; n=52,197, New York City)."
        ], 
        "Air pollutants and asthma": [
          "[5]  When total suspended particulates are greater than or equal to 181 micro-g/m3 in Taiwan, the odds of having asthma increase by 32%. When carbon monoxide is greater than or equal to 0.80 ppm, the odds of having asthma increase by 23%, and when ozone is greater than or equal to 0.022 ppm, the odds of having asthma increase by 7% (Wang et al 1999; n=165,173 adolescents, Taiwan). ", 
          "[6]  The author estimates that reducing annual concentrations of particulate matter from 90 micro-g/m3 to 75 micro-g/m3 (WHO guideline midpoint) would result in 558,000 fewer asthma attacks in the city's population (Ostro 1994; n=8.2 million, Jakarta, Indonesia). ", 
          ...
          "[8]  Odds of asthma attacks in children with asthma increased by 186% when there was a 50 micro-g/m3 increase of sulfur dioxide on that same day, and an increase of 145% after 1 day (Segala et al 1998; n=84, Paris). ", 
          "[9]  A study of traffic-related air pollution at home addresses and adult asthma incidence in six European cohorts revealed that asthma incidence was positively, but not significantly associated with NO2, NOx, PM10, PM2.5, PM2.5 absorbance, traffic load, and traffic intensity (Jacquemin et al., 2015; n=23,704, multi-country, Europe)."
        ]
      }
    }, 
    {
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Prior-week Ozone levels of 0.025ppm in Los Angeles, California were associated with an anxiety score of 1.07, while Ozone levels of 0.044pm were associated with an anxiety score of 1.33 on a scale from 0 to 4, with 4 being the highest level (Evans et al., 1988; n=1,002 adults, Los Angeles, California). ", 
          "[2]  Nurses who lived 50 to 200 m from the nearest major road were more likely to have anxiety than those living greater than 200 m away (adjusted OR 1.06, 95% CI: 1,01 to 1.12). While significantly increased odds of high anxiety were observed with higher exposure to PM2.5 across multiple averaging periods (1, 3, 6, and 12 months), associations for the shorter averaging periods were stronger than for the longer ones (Power et al., 2015; n=72,271, USA). "
        ]
      }
    }, 
    {
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Each increase of 10 micro-g/m3 fine particulate air pollution was associated with an 8% increase in lung cancer mortality (Pope III et al., 2002; n=500,000, USA). ", 
          "[2]  Those living in an environment with a high level of sulfate particles (23.5 micro-g/m3) were 36% more likely to have lung cancer compared to those living in a community with less pollution (3.6 micro-g/m3) (Pope et al., 1995; n=55,138 adults, USA &amp; Puerto Rico). ", 
          "[3]  The risk of lung cancer was 40% higher when the level of particulate deposition was greater than 298 g/m2/day (Barbone et al., 1995; n=1,510, Italy). ", 
          "[4]  For the period of 1977-92, when Ozone levels exceeded 100 ppb, risk of death caused by lung cancer for nonsmoking males increased by 319%. When PM10 levels exceeded 100 micro-g/m3, risk of death caused by lung cancer increased 18% for nonsmoking males and females (Abbey et al., 1999; n=6,338 Adventists, California). ", 
          "[5]  A case-control study of premenopausal women found a positive relationship between ambient concentration of NO2 and incidence of breast cancer from 1975 to 1994 (Hystad et al., 2015; n=3,310, Canada). ", 
          "[6]  Increases in doses of PM2.5 during dust storms significantly increased the frequency of human lymphocyte micronuclei (proxies for cancer due to chromosomal damage) compared to controls (p less than 0.01); for different PM 2.5 doses, cell nuclear division index values declined in a dose-response manner compared to controls (p less than 0.01) (Wei and Meng, 2006; n=4, Wuwei and Baotou, China). "
        ]
      }
    }, 
    {
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  From 1981-95, cardiovascular-related hospital admissions increased 4.8% for people 65+ when there was a 10 micro-g/m3 increase in black smoke (Prescott et al., 1998; n=450,000, Edinburgh). ", 
          "[2]  Each increase of 10 micro-g/m3 of PM2.5 was associated with a 24% increase in the risk of a cardiovascular event, such as heart attack or stroke, and a 76% increase in the risk of death from cardiovascular disease for postmenopausal women (Miller et al., 2007; n=65, 893, USA). ", 
          "[3]  A 25 micro-g/m3 increase in PM10 was associated with a 2.4% increase in hospital admissions for heart disease in the elderly (Schwartz et al., 1999; n=8 metro areas, USA). ", 
          ...
          "[5]  Increases in Ozone concentrations were not associated with hospitalizations for acute myocardial infarctions (heart attacks) (Nuvolone et al., 2013; n=1.35 million, five urban areas in Tuscany, Italy). ", 
          ...
          "[7]  Positive associations were found between spring, winter, and autumn dust events and relative risk ratios for total cardiovascular diseases among male participants (Meng and Lu, 2007; n=5607 Minquin, China). "
        ]
      }
    }, 
    {
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Of children tested, 57% in a highly polluted city had brain lesions compared to only 8% from a less polluted city. Children from the more polluted city performed overall at lower levels of psychometric intelligence, memory and executive functioning (Calderon-Garciduenas et al., 2008; n=18, Mexico). ", 
          "[2]  Children from schools with high traffic-related air pollution (TRAP) had lower improvements in working memory compared to children from schools with lower TRAP (e.g., 7.4% [95% CI: 5.6%-8.8%] versus 11.5% [95% CI: 8.9%-12.5%], p=0.0024) (Sunyer et al., 2015; n=2,750, Barcelona, Spain). ", 
          "[3]  Children with birth addresses within 50 m of a major roadway had lower mid-childhood nonverbal IQ scores [-7.5 points; 95% CI: -13.1, -1.9], verbal IQ scores (-3.8 points; 95% CI: -8.2, 0.6), and visual motor scores (-5.3 points; 95% CI: -11.0, 0.4) than children living greater than or equal to 200 m from a major roadway (Harris et al., 2015; n=1,109, Massachusetts, USA). ", 
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          ...
          "[2]  During winter, daily levels of smoke and SO2 were found to be significantly associated with respiratory-related hospital admissions. A 100 micro-g/m3 rise in SO2 or smoke might result in 15-21 additional acute respiratory hospital admissions each day. The mean daily levels of smoke and S02 were 12.7 micro-g/m3 and 39.1, respectively, with maximums of 188.3 micro-g/m3 and 126.3 micro-g/m3 (Walters et al., 1994; Birmingham, UK). ", 
          ...
          "[4]  For every 10 micro-g/m3 decline in PM10, there was an associated decline in prevalence of chronic cough (OR=0.65), bronchitis (OR=0.66), common cold (OR=0.78), nocturnal dry cough (OR=0.70 and conjunctivitis symptoms (OR=0.81) (Bayer-Oglesby et al., 2005; n=9,591, Switzerland). ", 
          ...
          "[6]  Positive associations were found between spring, winter, and autumn dust events and relative risk ratios for total respiratory diseases among male participants in a desert region (Meng and Lu, 2007; n=5607 Minquin, China). ", 
          "[7]  Following an intense dust storm, 34.7% of surveyed desert nomads exhibited respiratory symptoms that included mucus, nasal congestion, coughing, sputum, and difficult breathing (Mu et al., 2010; n=87, Mongolia). ", 
          "[8]  The prevalence of siliceous pneumoconiosis (lung disease caused by inhalation of crystalline silica dust) was 7.09% among residents aged 40 years or older living in a desert area with dust concentrations of 8.25-22.0 mg/m3 (Xu et al., 1993; n=395, China). "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "General and all-cause mortality": [
          ...
          "[2]  When looking at sulfate and fine particulate pollution (PM2.5 and less), mortality risk associated with each was roughly 15% and 17% higher, respectively, in the most polluted study cities than in the least polluted cities (Pope et al., 1995; n=55,138 adults, USA &amp; Puerto Rico). ", 
          "[3]  For the years 1981-95, positive associations were found between black smoke as a mean of the previous three days and daily all-cause mortality in people aged 65+. Also for people 65+, mortality increased by 3.9% with an increase in black smoke of 10 micro-g/m3 (Prescott et al., 1998; n=450,000, Edinburgh)."
        ], 
        "Respiratory mortality": [
          "[4]  For the years 1977-92, the relative risk of death for non-smokers increased by 18% when PM10 exceeded 100 micro-g/m3. For non-smoking males, when Ozone levels exceeded 100 ppb, relative risk of death caused by lung cancer increased by 319%. Sulfur dioxide showed strong associations with lung cancer mortality for both sexes (Abbey et al., 1999; n=6,338 Adventists, California). ", 
          "[5]  A statistically significant association between the average annual level of particulates and infant mortality from pneumonia was found in Rio de Janeiro, Brazil, when controlling for income variation (Penna &amp; Duchiade 1991; n=5,530,000, Brazil). ", 
          "[6]  Study subjects that participated in cycling and gardening were less likely to die of respiratory disease during moderate/low NO2 exposure [hazard ratio (HR)=0.55 (95% CI: 0.42, 0.72) and HR=0.55 (95% CI: 0.41, 0.73), respectively] than during high NO2 exposure HR=0.77 (95% CI: 0.54, 1.11 and HR=0.81 (95% CI: 0.55, 1.18, p-interaction=0.09 and 0.02), respectively (Andersen et al., 2015; n=52,061, Salt Lake County, Utah)."
        ], 
        "Cardiovascular and other mortality": [
          "[7]  A 6.3% increase in out-of-hospital coronary deaths was found for up to five days following every 10 micro-g/m3 increase in Ozone levels. Results suggested higher risks for females, elderly, and patients previously hospitalized for cerebrovascular and arterial diseases (Nuvolone et al., 2013; n=1.35 million, five urban areas in Tuscany, Italy). ", 
        ...
        "Suicide mortality": [
          "[9]  An increased risk of suicide was associated with IQR increases in NO2 during cumulative lag 3 (average of the 3 days preceding suicide; OR = 1.20, 95% CI: 1.04, 1.39) and PM2.5 on lag day 2 (day 2 before suicide; OR= 1.05, 95% CI: 1.01, 1.10) (Bakian et al., 2015; n=1,546, Salt Lake County, Utah)."
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          ...
          "[4]  A study of seniors found that a 10micro-g/m3 increase in particulate matter (PM2.5-10) was positively associated with significant increases in same-day cardiovascular hospitalizations [0.69%; 95% posterior interval (PI, using Bayesian statistics: 0.45, 0.92)]. The strongest associations were found for heart rhythm disturbances, with an increase of 0.94% (95% PI: 0.40, 1.48), followed by ischemic heart disease at 0.74% (95% PI: 0.29, 1.20) and cerebrovascular disease at 0.72% (95% PI: 0.22, 1.21) (Powell et al., 2015, n=110, multi-country). ", 
          "[5]  Significant associations were found between seasonal dust events with a lag of 3 days and relative risk ratios for cardiovascular and respiratory hospitalizations among male study participants in a desert region (Meng and Lu, 2007; n=5607 Minquin, China). "
        ]
      }
    }, 
    {
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          ...
          "[2]  Attained BMI among children living in residencies with high exposure to near-roadway pollution (NRP) and with no history of secondhand smoke (SHS) was 0.80 kg/m2 higher (95% CI: 0.27, 1.32) and 2.15 kg/m2 higher (95% CI: 1.52, 2.77) with high NRP and a history of SHS compared with children living with low exposure to NRP and no history of SHS (McConnell et al., 2015; n=3,318, California, USA). (McConnell et al., 2015; n=3,318, California, USA).   "
        ]
      }
    }, 
    {
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Respiratory and lung outcomes": [
          "[1]  A statistically significant association was found between average annual particulate levels and infant mortality from pneumonia in Rio de Janeiro, Brazil (Penna &amp; Duchiade 1991; n=5,530,000, Brazil). ", 
          "[2]  A cohort study analyzed the relationship between exposure to ambient air pollutants in women during the second trimester of pregnancy and lung function in their preschool children. Forced respiratory function in 1 s (FEV1) estimates for an IQR increase in exposure were found to be -18.4 mL (95% CI: -34.8 to -2.1) for benzene and -28.0 mL (95% CI -52.9 to -3.2) for NO2. Therefore, higher levels of ambient benzene and NO2 during pregnancy were associated with reduced lung function in preschool children (Morales et al., 2015; n=620, Sabadell and Gipuzkoa, Spain)."
        ], 
        "Cognitive outcomes": [
          "[3]  Children from schools with high traffic-related air pollution (TRAP) had lower improvements in working memory compared to children from schools with lower TRAP (e.g., 7.4% [95% CI: 5.6%-8.8%] versus 11.5% [95% CI: 8.9%-12.5%], p=0.0024) (Sunyer et al., 2015; n=2,750, Barcelona, Spain). ", 
        ...
        "Other outcomes": [
          ...
          "[7]  Attained BMI among children living in residencies with high exposure to near-roadway pollution (NRP) and with no history of secondhand smoke (SHS) was 0.80 kg/m2 higher (95% CI: 0.27, 1.32) and 2.15 kg/m2 higher (95% CI: 1.52, 2.77) with high NRP and a history of SHS compared with children living with low exposure to NRP and no history of SHS (McConnell et al., 2015; n=3,318, California, USA). ", 
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Across 10 green exercise case studies, participants reported reduced feelings of depression by over 2% after physical activity (Pretty et al., 2005; n=263, UK). ", 
          "[2]  Study subjects walking in a forest had improved self-reported mood states compared to those walking in urban areas (Lee et al., 2014; n=48, Japan). ", 
          "[3]  The presence of parks or recreation facilities in the neighborhood was significantly associated with a lower risk of depression (HR=0.80, CI: 065, 0.99) (Gariepy, et al., 2014; n=9,025, Canada). ", 
          "[4]  A study investigating affective outcomes of green exercise in four environments (beach, grassland, riverside, heritage) found that depression and tension significantly (p less than 0.001) decreased from pre- to post-run, but improvements in these measures were not significantly different between environments (Rogerson et al., 2015; n=331, UK). ", 
          "[5]  Pregnant women who lived in the highest quintiles for green space within 100m were 18-23% less likely to report depressive symptoms than those in the lowest quintiles. For the low education group, being in the greenest quintile was associated with a 26% reduction (OR=0.74, 95% CI: 0.59 to 0.94) of depressive symptoms compared to the least green quintile. Associations were stronger for active (OR=0.42, 95% CI: 0.29 to 0.61) compared with inactive individuals (OR 0.71, 95% CI 0.60 to 0.84) (McEachan et al., 2015; n=7,547, Bradford, England).  "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Study participants&#39; blood pressure was reduced following a 40-minute exercise treatment. Those with normal blood pressure achieved on average a 5% reduction in blood pressure, while those with abnormal blood pressure reported on average a 6.8% reduction (Raglin et al., 1987; n=30, Wisconsin). ", 
          "[2]  Participating in 20 minutes of &#39;fairly light&#39; exercise decreased mean arterial blood pressure by nearly 3%. Viewing a rural pleasant scene while exercising increased this effect by 6% (Pretty et al., 2005; n=100, UK). "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Study participants reported reduced feelings of tension-anxiety by roughly 7% after exercising for 20 minutes on a treadmill. This reduction increased when participants viewed pleasant rural and urban scenes while exercising (Pretty et al., 2005; n=100, UK). ", 
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  A national study found that long-term regular physical activity is associated with significantly better cognitive function and less cognitive decline in older women. Women who did the most physical activity were at a 20% lower risk of cognitive impairment (Weuve et al., 2004; n=18,766, USA). ", 
          ...
          "[4]  Older adults at risk for Alzheimer's Disease experienced improved cognitive function following an 18-month physical activity program (Lautenschlager et al., 2008; n=138, Australia). "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Across 10 green exercise case studies, participants reported reduced feelings of confusion by almost 5% after the physical activity (Pretty et al., 2005; n=263, UK). ", 
          "[2]  Across 36 studies investigating the linkage between physical activity and well-being in older adults, there was a significant reduction in confusion for those who participated in exercise as compared to those who participated in little or no exercise (Netz et al., 2005; n=36 studies, meta-analysis). ", 
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Study participants reported reduced feelings of anger/hostility by almost 4% after participating in physical activity (Pretty et al., 2005, n=263, UK). ", 
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  In a study of men aged 25-74, those whose energy output in walking, climbing stairs, and playing sports totaled 2000 or more kilocalories per week had a 28 percent lower death rate (from all causes) than less active men (Paffenbarger et al., 1986; n=12,936 men aged 25-74; USA). ", 
          "[2]  Stronger inverse associations were observed between participation in cycling and gardening (vs. no participation) and cardiovascular mortality: HR=0.78 (95% CI: 0.69, 0.88) and HR=0.82 (95% CI: 0.72, 0.93), respiratory mortality: HR=0.62 (95% CI: 0.50, 0.77) and HR=0.63 (95% CI: 0.50, 0.79), and diabetes mortality: HR=0.61 (95% CI: 0.42, 0.89) and HR=0.42 (95% CI: 0.28, 0.62), respectively (Andersen et al., 2015; n=52,061, Salt Lake County, Utah). ", 
          "[3]  Men who live in the greenest urban wards in the UK have had a 5% lower risk of cardiovascular disease mortality and 11% lower risk of respiratory disease mortality than men in the least green wards. No association was found for females. The authors propose the most likely mechanism for this finding is physical activity, where women are underrepresented in parks and green spaces and may not participate in the same levels of activity as men (Richardson and Mitchell 2010; n=28.6 million adults, UK). ", 
          "[4]  People living in the greenest areas had a 14% lower mortality rate from circulatory disease than those living in the least green areas (Lachowycz and Jones, 2014; n=165,424; United Kingdom). "
        ]
      }
    }, 
    {
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          ...
          "[3]  In a multi-study analysis, researchers found that acute short-term exposures to green exercise improved both self-esteem (effect size=0.46) and mood (effect size=0.54). This improvement increased with the presence of water and was true regardless of duration or intensity of exercise (Barton and Pretty 2010; n=1,252, UK). ", 
          "[4]  Researchers found that self-esteem scores improved more following exercise when compared to spending time in social activities. Out of the three study groups, those in the green exercise group had the greatest improvement in self-esteem (2.6 out of 40) (Barton et al., 2012, n=53, UK). ", 
          "[5]  Authors found a significant main effect for self-esteem (F(1)=6.10; p less than 0.05) and mood (F(6)=5.29; p less than 0.001) due to exercise, but no effect of viewing different environmental scenes (Wood et al., 2013; n=25 adolescents, UK). ", 
          "[6]  Significant main effect (F(1,74),=12.2, p less than 0.0001) for increase in self-esteem was found following exercise, but no effect was found for exercise condition (control vs green) (Reed et al., 2013; n=75 adolescents, UK).  "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Children with ADHD function 10% better after activities in green settings, when compared to activities indoors and activities in the built outdoor environment (Faber Taylor et al., 2001; n=96, USA). ", 
          "[2]  Children with ADHD who play in a green setting experience a significantly larger reduction of symptoms after the activity versus those that play indoors or in a built outdoor environment (Kuo &amp; Faber Taylor 2004; n=452, USA).  "
        ]
      }
    }, 
    {
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Increasing tree canopy by 10% within 50 meters of a mother's home was associated with a marginal decrease of 1.42 per 1,000 in the number of small for gestational age (SGA) births. (SGA births are often defined as those below the tenth percentile.)  Potential causal mechanisms for this finding include increased physical activity, stress reduction as a result of contact with green space, and improved social contacts-all of which have been proven to affect infant birth weight (Donovan et al., 2011; n=5,696, Oregon). ", 
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Study participants reported an 87% stress recovery ratio following their visit to a forest or park. Those who practiced sports while at the green space experienced greater reductions in stress than those who relaxed or walked (Hansmann et al., 2007, n=164, Switzerland). ", 
          "[2]  Of study respondents, those who frequently used green areas were rarely among the most stressed quarter of the study respondents (Nielsen and Hansen 2007; n=1,200, Denmark). ", 
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  In a multi-study analysis, researchers found that acute short-term exposures to green exercise improve both self-esteem (effect size=0.46) and mood (effect size=0.54). This improvement increases with the presence of water and is true regardless of duration or intensity of exercise (Barton &amp; Pretty 2010; n=1,252, UK). ", 
          "[2]  In another study, individuals walking in a forest had improved self-reported mood states when compared to individuals walking in urban areas (p less than 0.01) (Lee et al., 2014; n=48, Japan). ", 
          "[3]  A study found that, as the average time used for nature-based recreation increased by one unit on a scale from 1 to 6, emotional well-being was predicted to increase by 48% (Korpela et al., 2014; n=3,060, Finland). "
        ]
      }
    }, 
    {
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          ...
          "[6]  Following an outdoor nature-based recreation experience, veterans reported significantly higher attentional functioning, positive affect, and tranquility and significantly lower negative affect (Duvall and Kaplan 2014; n=98, Michigan, US). ", 
          "[7]  A study of 34 European nations found that socioeconomic inequalities in mental well-being (captured by the WHO-5 scale) were 40% narrower among urban dwellers with good access to recreational/green areas (chi-squared=16.08, p=0.041), compared with those reporting difficulty with access (Mitchell et al., 2015; n=21,294, Europe). "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          ...
          "[2]  Higher levels of greenness near maternal residences were associated with higher birth weight and infant head circumference. The observed effect was stronger among participants with low/moderate education levels. Potential mechanisms proposed by the authors include decreased personal exposure to air pollution (as evidenced by Dadvand and de Nazelle, 2012), and/or increased physical activity (Dadvand et al., 2012; n=2,393; Spain). ", 
          "[3]  A study exploring the density of street trees in relation to body weight reported 12% lower prevalence of obesity in low-income children aged 3-5 yrs. between the 1st and 3rd quartiles of street tree density (Lovasi et al., 2013; n=11,562, New York City). ", 
          "[4]  Pregnant women who lived in the highest quintiles for green space within 100m were 18-23% less likely to report depressive symptoms than those in the lowest quintiles. For the low education group, being in the greenest quintile was associated with a 26% reduction (OR=0.74, 95% CI: 0.59 to 0.94) in depressive symptoms compared to the least green quintile (McEachan et al., 2015; n=7,547, Bradford, England). ", 
          "[5]  Cross-sectional study of middle-school aged children found that a 5% increase in neighborhood area covered by trees was associated with 5% higher frequency of physical activity outside of school hours (Janssen and Rosu, 2015; n=5,138, Canada). ", 
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Those who engaged in physical activity while immersed in natural settings had increased energy levels when compared with sedentary individuals and those physically active in a laboratory setting (p less than 0.01) (Kinnafick and Thogersen-Ntoumani, 2014; n=40, United Kingdom). ", 
          "[2]  A study investigating affective outcomes of green exercise in four environments (beach, grassland, riverside, heritage) found that depression and tension significantly (p less than 0.001) decreased from pre- to post-run, but improvements in these measures were not significantly different between environments (Rogerson et al., 2015; n=331, UK). "
        ]
      }
    }, 
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Researchers found a 9.7% increase in hospital admissions for stress-related disorders, such as anxiety and panic disorder, during heat waves (temperatures above 26.7&#176; Celsius or 80.1&#176; F) (Hansen et al., 2008; n=1.16 million, Adelaide, Australia). "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  One multi-city study in the United States found that extreme heat events were associated with a 15% increase in hospitalizations for renal diseases (Gronlound et al., 2014; n=114 cities, United States). ", 
          "[2]  A California statewide and 6 sub-region study found that, on average, hospital admissions for acute renal failure increased by 7% on peak heat-wave days (Guirguis et al., 2014; n=2,510, California, United States). ", 
          "[3]  The risk of developing kidney stones was almost one and a half times higher at a temperature of 30&#176; C (86&#176; F) than at 10&#176; C (50&#176; F) (Tasian et al., 2014; n=60,433, Atlanta, Chicago, Dallas, and Philadelphia). "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          ...
          "[5]  Another study found that extreme cold and extreme heat posed significant risk for out of hospital coronary death. The risk was greater for patients that were 65 or older, male, and less educated (Chen et al., 2014; n=126,925, 6 Cities in China). ", 
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Heat waves were associated with 32.4% higher preterm births (Kent et al., 2014; n=60,466, Alabama, United States). "
        ]
      }
    }, 
    {
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          ...
          "[2]  During a Chicago heat wave in 1995, there were 11% more hospital admissions than average, of which 59% were for treatment of dehydration, heat stroke and heat exhaustion (Semenza et al., 1999). "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  During a Chicago heat wave in 1995, there were 11% more hospital admissions than average, of which 59% were for treatment of dehydration, heat stroke and heat exhaustion (Semenza et al., 1999). ", 
          ...
          "[4]  Compared to non-heat wave periods, there was a 17.4% increase in hospital admissions for dementia and a greater than 2-fold increase in hospital admissions for senility during heat waves (temperatures above 26.7&#176; Celsius or 80.1&#176; F) (Hansen et al., 2008; n=1.16 million, Adelaide, Australia). ", 
          "[5]  One multi-city study of the United States found that extreme heat events were associated with a 15% and 4% increase in hospitalizations for renal and respiratory diseases (Gronlound et al., 2014; n=114 cities, United States). ", 
          "[6]  A statewide and 6 sub-region study of California found that on average hospital admissions (primarily for cardiovascular disease, respiratory disease, mental health, acute renal failure, dehydration and heat illness) increased by 7% on peak heat-wave days (Guirguis et al., 2014; n=2,510, California, United States). "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Compared to non-heat wave periods, there was a 17.4% increase in hospital admissions for dementia and a greater than 2-fold increase in hospital admissions for senility during heat waves (temperatures above 26.7&#176; Celsius or 80.1&#176; F) (Hansen et al., 2008; n=1.16 million, Adelaide, Australia). ", 
          "[2]  Individuals who are socially isolated, including those who suffer from mental illness, may be particularly vulnerable to heat wave events (Reid et al., 2009; n=39,794 census tracts, USA). ", 
          "[3]  Within disadvantaged neighborhoods, the odds of having greater than or equal to 2 diagnosed chronic diseases was almost 6x and 4x higher for ages less than 65 and ages greater than or equal to 65 respectively, among individuals who report their physical and or mental health as &quot;adversely affected by summer time heat&quot; and self-describe themselves in &quot;poor health&quot; (Belanger et al., 2014; n=3,845, Quebec, Canada). ", 
          "[4]  A statewide and 6 sub-region study of California found that on average hospital admissions for mental health increased by 7% on peak heat-wave days (Guirguis et al., 2014; n=2,510, California, United States). "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Heat waves and mortality": [
          "[4]  During a 1995 summer heat wave event in Chicago, there were 514 heat-related deaths and 696 excess deaths during the month of July (Whitman et al., 1997). ", 
          "[5]  During an August heat wave event in 2003, an excess of 15,000 deaths were reported in France. Risk factors for death included population vulnerability (the elderly and infirm) and environmental factors such as living in an urban area (Vandentorren et al., 2006). ", 
          "[6]  During a July, 2006, heat wave in Porto, Portugal, a 1&#176; C (1.8&#176; F) increase in mean apparent temperature was associated with a 2.7% increase in all-cause mortality. The greatest number of excess deaths occurred on the third consecutive day of extreme heat (Monteiro et al., 2013). ", 
          "[7]  In the Netherlands, mortality was found to be 1.76% higher for each degree Celsius increase in temperature over the preceding month on the day of the increase (Kunst et al., 1993). ", 
          "[8]  There was a 240% increase in deaths (in the 64-74 age group) associated with mental and behavioral disorders during heat waves (temperatures above 26.7&#176; Celsius or 80.1&#176; F) (Hansen et al., 2008). ", 
          "[9]  When comparing a heat wave from 1998 to a similar heat wave in 2003, it was found that mortality was strongly related to the duration of the heat wave. Though the heat waves were very similar, low mortality rates were observed in 2003 which can be explained by increased use of air conditioning and a 16.1% increase in urban green area (Tan et al., 2007; Shanghai). ", 
          "[10]  In a multi-city study of high temperatures and mortality, the heat thresholds for all cities generally ranged from 20&#176;C to 35&#176;C (68&#176; F to 95&#176; F); above these thresholds, the negative effects of temperature on mortality were significant. Harmful effects of the daily maximum and mean temperatures on mortality were generally observed within first three days of the exposure (Gao et al., 2015, China). ", 
          "[11]  The effects of PM10 on cause-specific mortalities were found to be strongest for high temperature days. In the summer season, a 10 micro-g/m3 increase in PM10 was associated with a 1.40% increase in non-accidental cardiovascular deaths, a 1.37% increase in non-accidental cardiopulmonary deaths, and a 1.27% increase in non-accidental stroke deaths (Li et al., 2013; n=135,584 non-accidental death records, Tianjin, China). ", 
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          ...
          "[2]  One multi-city study of the United States found that extreme heat events were associated with a 4% increase in hospitalizations for respiratory diseases (Gronlound et al., 2014; n=114 cities, United States). ", 
          "[3]  A statewide and 6 sub-region study of California found that on average hospital admissions for respiratory diseases increased by 7% on peak heat-wave days (Guirguis et al., 2014; n=2,510, California, United States). "
        ]
      }
    }, 
    {
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Access to green space, including gardens, parks, and playgrounds, was found to be related to fewer conduct, peer and hyperactivity problems in children (Flouri et al., 2014; n=6,384, United Kingdom). ", 
          "[2]  Children with ADD had milder symptoms and better attentional functioning after activities in green settings, when compared to activities indoors and activities in the built outdoor environment (Faber Taylor et al., 2001; n=96, USA). ", 
          "[3]  Children with ADHD who play in a green setting experience a significantly larger reduction of symptoms after the activity versus those that play indoors or in a built outdoor environment (Kuo and Faber Taylor, 2004; n=452, USA). ", 
          "[4]  Preschool children that spent time in outdoor play environments covered by trees, shrubs or hilly terrain had less frequent inattention behaviors (p less than 0.05) (Martensson et al., 2009; n=198, Stockholm, Sweden). ", 
          "[5]  More greenness in a 100m residential buffer was significantly associated with lower ADHD and inattention scores in schoolchildren (p less than 0.05) (Amoly et al., 2014; n=2,111, Barcelona, Spain). ", 
          "[6]  Children with ADHD performed concentration tasks significantly quicker (by 0.26-0.98 seconds) in a wooded environment when compared to a town setting (van den Berg et al., 2011; n=12, Netherlands). ", 
          "[7]  Children with ADHD concentrated significantly better after a walk in the park than after a walk in an urban, downtown environment or in a suburban neighborhood (Faber, Taylor &amp; Kuo 2009; n=17, USA). ", 
          "[8]  In ten-year old children, the odds of hyperactivity/inattention problems were almost one and a half times higher for children living further than 500 meters from urban green spaces than those within 500 meters (Markevych et al., 2014; n=1,932, Munich, Germany). ", 
          "[9]  Compared to an indoor school setting, &quot;forest school&quot; had a significant positive effect on hedonic tone (one\u2019s capacity to feel pleasure)  (F=9.99, df=1, p=0.007), a trait closely associated with ADHD, in adolescents recruited from two deprived urban schools. This effect was more pronounced in adolescents with histories of poor behavior (Roe and Aspinall, 2011; n=18, Scotland). "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Both meditative and athletic walking in a forested environment reduced reported anxiety more than either of these activities in an indoor environment. In both settings, meditative walking was found to reduce anxiety more than athletic walking (Shin et al., 2013; n=139 young women, Korea). ", 
          "[2]  Exposure to a natural setting reduced feelings of anxiety by 1.46 points on a 5-point scale, while exposure to an urban setting reduced anxiety by .77 points on a 5-point scale (Ulrich et al., 1991). ", 
          "[3]  Running outdoors reduced anxiety by nearly 38% (Harte et al., 1995; n=10, Australia). ", 
          "[4]  Compared with scores after walking outdoors, walking indoors was associated with higher scores of anxiety (1 pt. on 6 pt. scale) for post-menopausal women (Teas et al., 2007; n=19, South Carolina). ", 
          "[5]  A study that focused on sick leave due to psychiatric diagnoses found that after nature-based rehabilitation, 63-71% of patients lowered their anxiety (p less than 0.0001-0.005) (Sahlin et al., 2015; n=105, Sweden). ", 
          "[6]  A 90-min walk in a natural setting, compared to an urban setting, decreased both self-reported rumination (p less than 0.05) and neural activity in the subgenual prefrontal cortex (associated with a self-focused behavioral withdrawal linked to rumination) (p less than 0.0001) in healthy participants (Bratman et al., 2015; n=90, San Francisco, California). ", 
          "[7]  Viewing pictures of urban landscapes increased anxiety slightly, while viewing pictures of nature with water present significantly decreased anxiety (Ulrich 1981; n=18, Sweden). ", 
          "[8]  Walking in a natural environment with a limited field of vision and with opportunities for concealment significantly increased reported levels of fear relative to pre-walk status (Gatersleben et al., 2013; n=17, southern England). ", 
          "[9]  Study subjects who perceived the absence of greenery and other public assets (places to walk or sit, or safe places for children to play) in their neighborhoods reported 2.5 times higher levels of anxiety and poor general health (Ellaway et al., 2009; n=1637, Scotland). "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          ...
          "[2]  Participants who viewed pictures of pleasant rural scenes while exercising experienced an almost 9% reduction in mean arterial blood pressure while those who exercised without viewing nature saw a less than 2% reduction (Pretty et al., 2005; n=100 [20/group], UK). ", 
          ...
          "[4]  A study analyzing pregnant women's residential proximity to city parks determined that, for every 300 m increase in residence distance from parks, the probability of normal blood pressure increased by 9% and the probability of high-normal blood pressure increased by 14% for pregnant women when compared to the optimal blood pressure category (Grazuleviciene et al., 2014; n=3,416, Lithuania). ", 
          "[5]  Visits to the forest environments among female patients diagnosed with exhaustion disorder were significantly restorative for diastolic blood pressure when compared to the city environment (p less than 0.002) (Sonntag-Ostrom et al., 2014; n=20, Sweden). ", 
          "[6]  The systolic and diastolic blood pressure of children living at residences within moderate greenness was higher than the blood pressures of children living in areas of high greenness (p less than 0.05) (Markevych et al., 2014; n=2,078, Mossel and Munich, Germany). "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Green space and birth outcomes": [
          "[1]  After assessing effect modification based on the level of maternal education, researchers detected an increase in birth weight among the lowest education group (n=164) who had higher surrounding greenness or lived close to a major green space, but found no other associations (Dadvand et al., 2012, n=8,246, Barcelona). ", 
          "[2]  Greenspace buffers between 100 m and 500 m were associated with birthweights that increased at least 15 g for each interquartile range increase in average greenness. Low income neighborhoods in particular were associated with strong, positive relationships between green space buffers and birth weight (Dadvand et al., 2014; n=10,780, Bradfurd, United Kingdom). ", 
          "[3]  A study of two German birth cohorts found that an interquartile increase of surrounding greenness at mother&#39;s residential address (within a 500-m buffer) was positively associated with an average birth weight increase of 17.6 g and the strongest association was found for mothers with less than 10 years of school education (Markevych et al., 2014; m=3,203 newborns, Munich, Germany)."
        ], 
        "Green space and children or adolescents": [
          "[4]  Access to green space, including gardens, parks, and playgrounds, was found to be inversely related to conduct, peer and hyperactivity problems in low-income children (Flouri et al., 2014; n=6,384, United Kingdom). ", 
          "[5]  Preschool children spending time in outdoor play environments covered by trees, shrubs or hilly terrain had less frequent inattention behaviors (p less than 0.05) (Martensson et al., 2009; n=198, Stockholm, Sweden). ", 
          "[6]  More greenness in a 100m residential buffer was significantly associated with lower ADHD and inattention scores in schoolchildren (p less than 0.05) (Amoly et al., 2014; n=2,111, Barcelona, Spain). ", 
          ...
          "[8]  Residential distances further from city parks were associated with poorer mental health in children whose mothers had a lower education level (Balseviciene et al 2014; n=1468, children 4-6 years and mothers 21-50, Lithuania). ", 
        ...
        "Land cover and vulnerable neighborhoods": [
          "[11]  Percent tree canopy per block group was positively correlated with neighborhood median household income and education levels (Holtan et al., 2014; n=361, Baltimore, Maryland, United States). ", 
          "[12]  A high provision of ecosystem services equated to less populated areas with more educated and affluent residents (Dobbs et al., 2014; Melbourne, Australia). ", 
          "[13]  Populations exposed to the greenest environments also have the lowest levels of health inequality related to income deprivation. Thus, despite increased mortality risk associated with income deprivation, this risk was lower for those who lived in greener areas. The incidence rate ratio (IRR) for all-cause mortality for the most income-deprived quartile compared with the least deprived was 1.93 (95% CI 1.86-2.01) in the least green areas, whereas it was 1.43 (1.34-1.53) in the most green (Mitchell and Popham 2008; n=4.8 million +, England). ", 
          ...
          "[15]  Women of lower academic achievement (year 10 or less for their education) lived in environmentally degraded areas with high soil salinity levels compared to women with university education (p=0.013) (Fearnley et al., 2014; n=1,758, Australia)."
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Living in a residence surrounded by at a buffer of at least 100 m of greenspace was associated with 17% reduced odds of being overweight or obese (Dadvand et al., 2014; n=3,178, Sabadell, Spain). ", 
          "[2]  Another study found that children living closest to recreational open space had a lower cross-sectional BMI z-score compared with children living farthest away. This difference of 0.06 units in BMI z-score translated to a 0.3 kg (0.6 lb) difference in body weight (Duncan et al., 2014; n=49,770, Massachusetts, United States). ", 
          "[3]  The odds of obesity were reduced by more than half for adults who perceived that they had a park, playground, or open space in their neighborhood when compared to those that did not (Sullivan et al., 2014; n=6,082, Michigan, US). "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Walking outdoors reduced confusion by nearly 8% (Peacock et al., 2007; n=20, UK). ", 
          "[2]  People who exercised while viewing urban scenes reported reduced feelings of confusion by 5% following the activity (Pretty et al., 2005; n=100, UK). "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  After running outdoors, subjects reported feeling significantly less depressed-an 85% reduction (Harte et al., 1995; n=10, Australia). ", 
          "[2]  Taking a walk outdoors reduced depression by 6%, while walking indoors had little effect (Peacock et al., 2007; n=20, UK). ", 
          "[3]  People who took part in green exercises reported reduced feelings of depression by 2% after the activity (Pretty et al., 2005; n=263, UK). ", 
          "[4]  The presence of parks or recreation facilities in the neighborhood was significantly associated with a lower risk of depression (HR=0.80, CI: 065, 0.99) (Gariepy, et al., 2014; n=9,025, Canada). ", 
          "[5]  Pregnant women who lived in the highest quintiles for green space within 100m were 18-23% less likely to report depressive symptoms than those in the lowest quintiles. For the low education group, being in the greenest quintile was associated with a 26% reduction (OR=0.74, 95% CI: 0.59 to 0.94) in depressive symptoms compared to the least green quintile (McEachan et al., 2015; n=7,547, Bradford, England). ", 
          "[6]  Identical twins with higher residential neighborhood greenness had a lower risk of depression in the crude model (-0.44, 95% CI: -0.74 to -0.14). The results were similar in all four adjusted models (Cohen-Cline et al., 2015; n=4,338, USA). ", 
          "[7]  Study subjects who perceived the absence of greenery and other public assets (places to sit or walk, or safe places for children to play) in their neighborhoods were 90% more likely to feel depressed or sad (Ellaway et al., 2009; n=1637, Scotland). ", 
          "[8]  A study that focused on sick leave due to psychiatric diagnoses found that after nature-based rehabilitation, about 88% of patients lowered their depression (p less than 0.0001) (Sahlin et al., 2015; n=105, Sweden). ", 
          "[8]  Saline areas, defined as areas where salinity is moderate, high or extreme, was linked to a greater relative risk (RR=1-1.3) for depression (Speldewinde et al., 2009; n=4,08,096, Australia). "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Those who engaged in physical activity while immersed in natural settings had increased energy levels when compared with sedentary individuals and those physically active in a laboratory setting (p less than 0.01) (Kinnafick and Thogersen-Ntoumani, 2014; n=40, United Kingdom). ", 
          "[2]  Taking a walk outdoors reduced fatigue (nearly 15%) and increased feelings of vigor (3%), while walking indoors had only half the same effect for fatigue and decreased feelings of vigor (Peacock et al., 2007; n=20, UK). ", 
          "[3]  Participants reported significantly increased energy after walking outdoors (condition effect 21.99) while exercising and viewing nature through virtual reality had little effect (Plante et al., 2006; n=112, US). ", 
          "[4]  Running outdoors reduced fatigue by 26%, while subjects felt more fatigued after running indoors (Harte et al., 1995; n=10, Australia). ", 
          "[5]  Those who walked on a natural path experienced significantly increased vitality, while those who walked indoors showed no change in vitality over time (Ryan et al., 2010; n=80, Canada). ", 
          "[6]  Two hours of walking in the forest improved sleep characteristics, impacting actual sleep time, immobile minutes, self-rated depth of sleep, and sleep quality. Mean actual sleep time increased on the night after forest walking was 419.8 (+/- 128.7) minutes compared to 365.9 (+/- 89.4) minutes the night before (Morita et al., 2011; n=71, Japan). ", 
          "[7]  Compared to an indoor school setting, &quot;forest school&quot; had a significant positive effect on energy (F=9.65, df=1, p=0.007) in adolescents recruited from two deprived urban schools. This effect was more pronounced in adolescents with histories of poor behavior (Roe and Aspinall, 2011; n=18, Scotland). "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  In a study using a phone app to record happiness levels in different environments, participants reported being significantly happier outdoors in all green or natural habitat types than in urban settings (1.8 to 2.7 points happier on a 0-100 scale). Marine and coastal shorelines were the happiest locations--approximately 6 points higher than urban environment--a difference similar to attending an exhibition versus doing housework (MacKerron &amp; Mourato 2013; n=21,947, UK). ", 
          "[2]  College students who spent time in a natural environment versus an urban environment or in passive relaxation reported higher overall happiness (Hartig et al., 1991; n=34, California).  ", 
          "[3]  Both meditative and athletic walking in a forested environment increased reported happiness more than either of these activities in an indoor environment. In both settings, meditative walking was found to increase happiness more than athletic walking (Shin et al., 2013; n=139 young women, Korea). ", 
          "[4]  Compared with scores after walking outdoors, walking indoors was associated with lower scores for feelings of being pleased (0.8 point lower on a 6-point scale) and lower scores for feelings of delight (0.9 point lower on a 6-point scale) for post-menopausal women (Teas et al., 2007; n=19, South Carolina). ", 
          ...
          "[6]  Frequent group walks in green corridors or farmland versus urban areas were associated with significantly reduced scores for negative affect (emotional state) in a study of primarily older adults (55 years or older) (Marselle et al., 2013; n=708, England). ", 
          "[7]  Those who engaged in physical activity while immersed in natural settings had a more positive affect when compared with sedentary individuals and those physically active in a laboratory setting (p less than 0.01) (Kinnafick and Thogersen-Ntoumani, 2014; n=40, United Kingdom). ", 
          "[8]  Walking in a natural environment with a limited field of vision and with opportunities for concealment significantly increased reported levels of sadness relative to pre-walk status (Gatersleben et al., 2013; n=17, southern England). ", 
          "[9]  Also, biodiversity might be associated with happiness, as individuals that visited parks with greater plant diversity levels reported higher levels of happiness (Suarez et al., 2014; 2014; n=10, Grenada, Spain). ", 
          "[10]  Study participants who were shown various photos of urban or natural settings following the viewing of a stressful video reported improved positive feelings after viewing the natural settings (Ulrich 1991; n=120, Delaware). ", 
          "[11]  In a study comparing two neighborhoods with varying levels of green space, those in the greener neighborhood reported higher levels of satisfaction and happiness (Herzele and de Vries 2011; n=190, Belgium). ", 
          "[12]  As engagement with natural beauty increased by one unit, life satisfaction was predicted to increase by 15% (Zhang et al., 2014; n=Study 1: 1108, Study 2: 151; Berkeley, CA). "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Those individuals who had higher levels of nearby nature reported fewer acts of aggression and violence against others. Nearby nature was related to lower scores on multiple indices of aggression against partners and one index of aggression against children (Kuo et al., 2001; n=145, Chicago). ", 
          "[2]  &quot;Forest school&quot; had a significant positive change on anger (F=6.65, df=1, p=0.020) in adolescents recruited from two deprived urban schools. This effect was more pronounced in adolescents with histories of poor behavior (Roe and Aspinall, 2011; n=18, Scotland). ", 
          "[3]  People who took part in green exercise reported reduced feelings of anger and hostility by 4% after the activity (Pretty et al., 2005; n=263, UK). ", 
          "[4]  Taking a walk outdoors can reduce feelings of anger by nearly 8% (Peacock et al., 2007; n=20, UK). ", 
          "[5]  Running outdoors can reduce feelings of hostility by 80% (Harte et al., 1995; n=10 males, Australia). ", 
          "[6]  Exposure to a natural setting reduces feelings of aggression by 1.95 points on a 5-point scale, while exposure to an urban setting reduces aggression by 0.82 point on a 5-point scale (Ulrich et al., 1991; n=120, Delaware). ", 
          "[7]  Significant decreases in anger (p=0.004) were reported after female workers in healthcare and counseling service industries were exposed to forest therapy (Jung et al., 2015; n=211, Kuyungii Province, South Korea). "
        ]
      }
    }, 
    {
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Both meditative and athletic walking in a forested environment increased reported self-esteem more than either of these activities in an indoor environment. In both settings, meditative walking was found to increase self-esteem more than athletic walking (Shin et al., 2013; n=139 young women, Korea). ", 
          "[2]  Taking a walk outdoors improved self-esteem by 25% (Peacock et al., 2007; n=20, UK). ", 
          "[3]  People who took part in green exercise reported a 9% improvement in self-esteem after the activity (Pretty et al., 2005; n=263, UK). ", 
          ...
          "[5]  After viewing different outdoor scenes and exercising, participants experienced positive changes in self-esteem (Pretty et al., 2005; n=100, UK). ", 
          "[6]  Reported self-esteem was higher following exposure to a mild stress for study participants who had first viewed images of natural versus urban scenes (Brown et al., 2013; n=25, England). ", 
          "[7]  In two similar studies evaluating natural/green effect on adolescent self-esteem, findings showed no effect of viewing different scenes (Wood et al., 2013; n=25, UK) or exercising in different conditions (Reed et al., 2013; n=75, UK) on self-esteem.  In both cases, significant main effect was found for exercise alone.   "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Increased social interactions": [
          "[1]  With every unit increase of greenness in common space, residents of an urban public housing community saw a 1/3-unit increase in neighborhood social ties. With every unit increase of use of common space, there was a 1/5-unit increase in neighborhood social ties (Kuo et al., 1998; n=145, Chicago). ", 
          "[2]  The presence of trees was significantly associated with the presence of people in outdoor public spaces in an urban housing community. The mean number of people in areas with no trees was 1.32; the mean number of people in areas with trees was 4.45, 237% higher (Coley et al., 1997; observational, Chicago). ", 
          "[3]  Social capital, defined as social connection or association, was positively correlated with tree canopy (measured as percentage of tree canopy per block group). Also, a linear regression found that tree canopy density was positively related to social capital (Holtan et al., 2014; n=361, Baltimore, Maryland, United States). ", 
          "[4]  Urban residents who reported visiting a local park for more than 30 minutes, versus those who did not, were three times as likely to have four or more good friends in the area. People who reported engaging in social activities in a local park versus those who did not were almost four times as likely to have 14 or more acquaintances in the area (Kazmierczak 2013; n=236, England). ", 
          "[5]  Spending time in outdoor environments was found to be important for social inclusion in children-43% of survey respondents mentioned outdoor environments (parks, playgrounds) as places to make friends and spend time (Seeland et al., 2009; n=437, Switzerland). ", 
          "[6]  Aging residents living in environments perceived as having high and very high levels of green space were more likely to have a high level of social connectedness with neighbors than aging residents in environments with little green space (Kemperman and Timmermans, 2014; n=1,501, United States)."
        ], 
        "Prosocial behavior": [
          "[7]  A 1% increase in park acreage showed a 0.01% increase in perceived social support (Fan et al., 2011; n=1544, Chicago). ", 
          "[8]  A positive, significant correlation was found between neighborhood commitment among residents, as determined by a Neighborhood Commitment Scale, and neighborhood greenness (McCunn and Gifford, 2014; n=84, Canada). ", 
          "[9]  Results of qualitative interviews of young adults attending four-week wilderness camp revealed that natural environment enhanced the processes of making friends and being part of a group (Warber et al., 2015; n=54, West Virginia, USA). ", 
          "[10]  Results of a fishing simulation task showed that participants who watched a nature video harvested significantly fewer fish per season and had commons pools that lasted more seasons (more cooperative and sustainable behavior) compared to those who watched a control video. By season 15, 49% of the control group&#39;s ocean fisheries went extinct, compared to 29% of the test group&#39;s (chi-squared (1, N=111)=4.92, p=0.03) (Zelenski et al., 2015; n=111, New York City)."
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Green exposure at home and school": [
          "[1]  Attentional functioning scores were significantly higher for urban public housing residents who lived in a green setting versus a barren setting. The scores differed by more than one third of a standard deviation (Kuo and Sullivan 2001; n=145, Chicago). ", 
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Increasing tree canopy by 10% within 50 meters of a mother's home was associated with a marginal decrease of 1.42 per 1,000 in the number of small for gestational age (SGA) births. (SGA births are often defined as those below the tenth percentile.)  Potential causal mechanisms for this finding include stress reduction as a result of contact with green space, improved social contacts, and increased physical activity-all of which have been proven to affect infant birth weight (Donovan et al., 2011; n=5,696, Oregon). ", 
          "[2]  After assessing effect modification based on the level of maternal education, researchers detected an increase in birth weight among the lowest education group (n=164) who had higher surrounding greenness or lived close to a major green space, but found no other associations (Dadvand et al., 2012, n=8,246, Barcelona). ", 
          "[3]  Birth weights increased by at least 15 g for each interquartile range increase in greenness measured in buffers between 100 m and 500 m around the home. Low income neighborhoods in particular were associated with strong, positive relationships between greenness in residential buffers and birth weight (Dadvand et al., 2014; n=10,780, Bradfurd, United Kingdom). ", 
          "[4]  For each 0.1 increase from -1 to 1 in greenness, the odds of a birth being very preterm, moderately preterm, or small for gestational age were reduced. Term birth weight was 20.6 g higher on average with each 0.1 increase in a greenness measure (Hystad et al., 2014; n=64,705, Vancouver, BC, Canada). ", 
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Green space in everyday environments": [
          "[1]  Two related studies in economically deprived communities found inverse relationships between neighborhood green space and both self-reported stress and objective markers of stress as measured by levels and patterns of cortisol secretion (Roe et al., 2013; n =106; Ward Thompson et al., 2012; n=25, Scotland). The larger study also found significant gender differences--women in less green neighborhoods showed higher levels of stress than men, and the relationship of cortisol measures to perceived stress was dissimilar between genders. ", 
          "[2]  People who visited urban green spaces more often reported lower levels of stress (includes fatigue and irritation). Additionally, those who reported wishing to be outdoors in green spaces more often suffered from higher levels of stress (Grahn and Stigsdotter 2003; n=953, Sweden). ", 
          "[3]  Study participants reported significantly lower stress levels after exposure to urban settings with high natural content relative to more built settings. There was a greater decrease in subjective stress for women versus men following exposure to the most natural setting (Beil and Hanes 2013; n=15, Portland, OR). ", 
          "[4]  People who lived in greener areas experienced less noise-annoyance from traffic than those in less green areas and also exhibited less stress-related psychological symptoms that are associated with noise annoyance (Gidlof-Gunnarsson and Ohrstrom 2007; n=500, Sweden). ", 
          "[5]  Nearby nature was found to buffer the effects of stressful live events on children&#39;s psychological distress (Rutter scale). Areas with high nature showed less impact of stressful life events on the children sampled (Wells and Evans 2003; n=337, New York). ", 
          "[6]  Individuals who had private gardens said that these gardens allowed them to connect with nature, relieve stress, and interact with others (Freeman et al., 2012; n=55, New Zealand). ", 
          "[7]  Results showed significant relationships between physical and visual access to workplace greenery, and a positive workplace attitude for both men and women. This relationship was also found for decreased levels of stress in men but not in women (Lottrup et al., 2013; n=439, Sweden). ", 
          "[8]  A study conducted to compare crimes and health associated with the greening of vacant lots found that vacant lot greening significantly reduced gun assaults citywide and self-reported reductions in stress levels in sections of the city (Branas et al., 2011; Philadelphia)."
        ], 
        "Visits to natural areas": [
          "[9]  People who visited wilderness areas reported substantial reductions in stress and tension, as well as mental rejuvenation (Cole and Hall 2010; n=531 Western USA). ", 
          ...
          "[11]  When comparing time spent in urban environments versus forest, study participants had reduced salivary cortisol levels and a stimulated parasympathetic nervous system while in the forest environment. This means that participants were less stressed and more physiologically relaxed in the forest environment (Lee et al., 2011; n=12, Japan). ", 
          "[12]  While viewing forest scenery for 15 minutes, parasympathetic nervous activity (PNA) was enhanced (p less than 0.01), sympathetic NA was suppressed, and measured diastolic blood pressure (BP) was significantly lower (p=0.034) when in forested areas than in urban areas. Reported POMS scores showed less negative and more vigorous moods in forested areas. These findings suggest even short-term exposure to greenery can have a relaxing effect (Tsunetsugu et al., 2013; n=48, Japan). ", 
          "[13]  Frequent group walks in green corridors or farmland versus urban areas were associated with significantly reduced scores for perceived stress in a study of primarily older adults (55 years or older) (Marselle et al., 2013; n=708, England). ", 
          "[14]  However, walking in a natural environment with a limited field of vision and with opportunities for concealment significantly increased reported levels of fear relative to pre-walk status (Gatersleben et al., 2013; n=17, southern England). ", 
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Green space in urban environments": [
          ...
          "[2]  In a 5-year longitudinal study exploring how moving to a greener or less green area may affect mental health over time, results showed that individuals who moved to greener areas had significantly better mental health in all three post-move years, showing sustained mental health gains and supporting a shifting baseline hypothesis (Alcock et al., 2013; n=1,064, UK). ", 
          "[3]  Mobile EEGs were used to record emotional changes as study participants walked through an urban environment. Analysis showed that directed attention (arousal, frustration, engagement) decreased and meditation increased when participants moved from an urban shopping street into green space (Aspinall et al., 2013; n=12, Edinburgh). ", 
          "[4]  Overall perceived mental restoration was higher in study participants exposed to urban woodlands than an urban park and built-up city center (p less than 0.05) (Tyrvainen et al., 2014; n=77, Helsinki, Finland). ", 
          "[5]  Biodiversity was beneficially linked to numerous self-reported physical, psychological and mental measures in both urban green areas (p=0.000) and peri-urban green areas (p=0.000). Additionally, these measures were significantly correlated with length of visit to green areas (p=0.000) (Carrus et al., 2015; n=569, Italy). ", 
          "[6]  As distance from parks increased by one unit, mental health declined by 2 and 4.6 points for participants living between 400m-800m and 800m-1.6 km from a park, respectively (Sturm and Cohen, 2014; n=1,070, Los Angeles, California). ", 
          "[7]  Residential distance from city parks was negatively associated with mental health in children whose mothers had a lower education level (Balseviciene et al., 2014; n=1,468, Lithuania). ", 
          "[8]  Moderate amounts of green space (34-66%) at the neighborhood ward level was marginally protective for minor psychiatric morbidity, as indicated by a 12-item psychiatric health questionnaire, but only for men in early to mid-adulthood (Astell-Burt 2014; n=65,407, United Kingdom). ", 
          "[9]  Women who lived over 300 m from a park and visited a park at least 4 hrs/week, were almost twice as likely to have depressive symptoms as those living within the same distance but visiting a park less frequently (Reklaitiene et al., 2014; n=6,944 Age 45-72; Kaunas city, Lithuania). ", 
          "[10]  Study participants living in neighborhoods containing medium or high quality public open space attributes (water features, birdlife, walking paths, playgrounds, and lawns) reported twice the odds of low psychological distress than those living in neighborhoods containing low quality public open space (Francis et al., 2012; n=911, Perth, Australia)."
        ], 
        "Visiting natural environments": [
          "[11]  Survey respondents asked to recall feelings of restoration from prior visits to various natural environments reported the greatest feelings of restoration while visiting coastal areas, followed by rural green and urban green areas, respectively. Environment and activity type, as well as time spent, affected recalled restoration (White et al., 2013; n=4,255, UK). ", 
          "[12]  Exposure to natural forest was associated with reduced cerebral oxygenated hemogloblin (HbO2) levels, indicating improved brain functioning, and was associated with improved scores on the Profile of Mood States (POMS) test, indicating an improved mood (Horiuchi et al., 2014; n=15, Yamanashi, Japan). ", 
          "[13]  Forest visits among female patients diagnosed with exhaustion disorder were mood enhancing when compared to the city environment (p less than 0.001) (Sonntag-Ostrom et al., 2014; n=20, Sweden). ", 
          "[14]  After attending a four-week wilderness camp, young adults had increased positive affect (t(30)=4.25, p less than 0.001) and decreased negative affect (t(34)=-3.23, p=0.003) (Warber et al., 2015; n=54, West Virginia, USA)."
        ], 
        "Green space access and design": [
          "[15]  Respondents who were dissatisfied with their access to green open spaces were 69% more likely to be in the lowest quartile for mental health (Guite et al., 2006; n=1,012, London). ", 
          "[16]  A study of 34 European nations found that socioeconomic inequalities in mental wellbeing (captured by the WHO-5 scale) were 40% narrower among urban dwellers with good access to recreational/green areas (chi-squared=16.08, p=0.041), compared with those reporting poor access (Mitchell et al., 2015; n=21,294, Europe)."
        ]
      }
    }, 
    {
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          ...
          "[2]  Study subjects walking in a forest had significantly lower heart rates than those walking in an urban area (p less than 0.01) (Lee J, et al., 2014; n=48, Japan). ", 
          "[3]  Among non-park users, the prevalence of cardiovascular disease (CVD) was one and a half times greater for those who lived greater than or equal to 350 meters away as compared to those who lived closer (Tamosiunas et al., 2014; n=5,112 aged 45-72, Kaunas City, Lithuania). ", 
          "[4]  Results from analyses suggest that people who live in areas with larger trees and higher street tree density report better health and fewer cardio-metabolic conditions compared with those living in areas with smaller trees and lower street tree density. For example, having 11 more trees in a city block decreased cardio-metabolic conditions is equivalent to an increase in annual personal income of $20,000 or being 1.4 years younger (Kardan et al., 2015; n=94,427, Toronto, Canada). ", 
          "[5]  Post-menopausal women living in U.S. counties with high rates of tree mortality due to the emerald ash borer had an increased risk of cardiovascular disease (HR=1.25, 95% CI: 1.20-1.31) (Donovan et al., 2015; n=161,808, USA). "
        ]
      }
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  In a randomized, controlled trial, senior women who walked around a forested area for an hour showed significant increases in mean values for two measures of pulmonary function: forced expiratory volume (FEV) in 1 second (12.3% increase), and FEV in 6 seconds (11.3% increase). Women in the control group who walked around an urban area for an hour did not show a significant change in either measurement (Lee &amp; Lee 2013; n=62, Korea). "
        ]
      }
    }, 
    {
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  In determining the association between the respiratory health of young children and home dampness and molds, researchers determined that the odds of asthma for children were increased 29% when dampness and/or mold were present in the home (Dales et al., 1991; n=13,495, Canada). ", 
          "[2]  Those individuals with pre-existing asthma who were interviewed from flooded households reported more cases of worsening asthma (48%) than those interviewed from non-flooded households (25%) (Reacher et al., 2004; n=467, Southern England). "
        ]
      }
    }, 
    {
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  In the 12 months following the Bristol Floods of 1968, there were 23 hospital admissions among the 209 households affected, compared to only 3 hospital admissions in those same households in the 12 months prior to flooding. No significant difference was found in the non-flooded homes (Bennet 1970; n=770, Bristol, England). ", 
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  In the 12 months following the Bristol Floods of 1968, there were 87 deaths among the 209 households affected, compared to 58 deaths in those same households in the 12 months prior to flooding-a rise of 50%. No significant difference was found in the non-flooded homes (Bennet 1970; n=770, Bristol, England). ", 
          "[2]  A total of 1,185 deaths were associated with 32 flash floods that occurred between 1969 and 1981 in the United States. This came out to be an average of 37 deaths per flash flood event (French et al., 1983; n=1,185, USA). "
        ]
      }
    }, 
    {
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Stomach cancer mortality in regions with Chromium contaminated water was 82% more likely in comparison with the regions without contaminated water. Lung cancer mortality was 15% more likely in regions with contaminated water (Beaumont et al., 2008; Liaoning Province, China). ", 
    ...
    }, 
    {
      ...
      "text": {
        ...
        "Evidence": [
          "[1]  Giardiasis was strongly associated with fecal coliform contamination in water networks of Gaza (r=0.7) (Yassin et al., 2006; n=138, Gaza Strip, Palestinian Territory). ", 
          "[2]  The presence of forest cover significantly decreased the odds that a child less than 5 yrs. had recently experienced diarrhea--from 15% (at 10-19% forest cover within 25 km2) to 92% (at 50-59% forest cover within 25 km2) (Johnson et al., 2013; n greater than 23,000 households, Malawi). ", 
          "[3]  The risk of gastrointestinal symptoms increased with Copper exposure levels in drinking water. Risk was 53% higher for women with a concentration of 4 mg/L and 90% higher for men with a concentration of 6 mg/L (Araya et al., 2004; n=1,365 adults, Chile). ", 
          "[4]  When looking at the relationship between gastrointestinal illness and copper exposure in drinking water, symptoms such as nausea, diarrhea, vomiting and abdominal cramps were reported as a result of elevated copper levels in drinking water. Findings suggest that drinking water containing copper levels above 1.3 mg/l may be a common cause for gastrointestinal upsets (Knobeloch et al., 1994; 5 case studies, Wisconsin). "
        ]
      }
    }, 
    {
    ...
    }, 
    {
      ...
      "target_text": "Mortality", 
      "text": {
        "Water Quality | Mortality": "Among a population in Greece where an aquifer was contaminated with Chromium, observed deaths were 98 times what were expected for that region based on age and gender (Linos et al., 2011; n=131,000, Viotia, Greece). ", 
        "Evidence": []
      }
    }, 
    {
      ...
      "target_text": "Preterm Birth", 
      "text": {
        "Water Quality | Preterm Birth": "Researchers found that significant decreases in gestational duration are associated with in-utero organophosphate pesticide exposure, especially increased exposure in the latter part of pregnancy. For every log10 unit increase in pesticide exposure there was a 0.41 week (2.9 days) decrease in gestation (Eskenazi et al., 2004; n=601 low-income, Latina women, California). ", 
        "Evidence": []
      }
    }, 
    {
